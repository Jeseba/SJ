...
<h6>REPORTE DE ASISTENCIA POR SECCIÓN</h6>
<hr/>
</div>
<div class="container my-2">
<form action="alumnos_asistencia_general_pdf_x_seccion.php" method="post">
<!-- <form action="alumnos_buscar_x_documento_form_mostrar.php" method="GET"> -->
<div class="form-body">
<div class="row">
<div class="form-group has-icon-left">
<label for="first-name-icon">Grado :</label>
...
<div class="form-group has-icon-left">
<label for="first-name-icon">Sección :</label>
...
<input class="form-control" id="DT_Fecha_Desde" name="DT_Fecha_Desde" placeholder="Ingrese Nombres y Apellidos" required="" type="date"/>
...
<button class="btn btn-success btn-sm" id="BT_Exportar_Excel" type="button">Exportar Excel</button>
</div>
<div class="col mt-4 text-end">
...
$(document).ready(function() {
    $('#BT_Exportar_Excel').on('click', function() {
        console.log('Botón presionado'); // Verifica si el clic está funcionando
        
        var fechadesde = document.getElementById("DT_Fecha_Desde").value;
        var fechahasta = document.getElementById("DT_Fecha_Hasta").value;
        var seccion = document.getElementById("Combo_Seccion").value;
        var Grado = document.getElementById("Combo_Grado").value;
        ...
        if(fechadesde && fechahasta && seccion) {
            window.location.href = 'alumnos_asistencia_general_x_seccion_excel.php?DT_Fecha_Desde=' + encodeURIComponent(fechadesde) + 
                                   '&DT_Fecha_Hasta=' + encodeURIComponent(fechahasta) + 
                                   '&T_Seccion=' + encodeURIComponent(seccion) +
                                   '&T_Grado=' + encodeURIComponent(Grado);
        } else {
