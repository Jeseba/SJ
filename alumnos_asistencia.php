...
<p class="text-subtitle text-muted">Registro de Asistencias por dia,mes y fechas</p>
</div>
</div>
</div>
...
<div class="col-auto">
<label class="col-form-label" for="inputPassword6">Desde</label>
</div>
<div class="col-auto">
<!-- <input type="date" class="form-control" placeholder="Start" name="date1" /> -->
<input class="form-control" id="from_date" name="from_date" type="date" value="2025-06-25"/>
</div>
<div class="col-auto">
<label class="col-form-label" for="inputPassword6">Hasta</label>
</div>
<div class="col-auto">
<!-- <input type="date" class="form-control" placeholder="End" name="date2" /> -->
<input class="form-control" id="to_date" name="to_date" type="date" value="2025-06-25"/>
</div>
<div class="col-auto">
...
<div class="col-auto">
<button class="btn btn-primary me-2 mb-2" data-bs-target="#nuevoModal" data-bs-toggle="modal" type="button">Reporte
                            </button>
<!-- <label for="" class="col-form-label"></label>
                            <span class="badge bg-success"> <i class="bi bi-check-circle"></i>Asistio</span>
                            <span class="badge bg-warning"> <i class="bi bi-exclamation"></i>Incompleto</span>
                            <span class="badge bg-info"> <i class="bi bi-check"></i>Permiso</span>
                            <span class="badge bg-danger"> <i class="bi bi-x-circle"></i>Falto</span>
                            <span class="badge bg-secondary"> <i class="bi bi-x-circle"></i>Tardanza</span> -->
</div>
</div>
</div>
</div>
...
<!-- <table id="table1" class="table table-striped table-condensed table-bordered dt-responsive nowrap table-hover" cellspacing="0" width="100%"> -->
<thead>
<tr><th data-sortable="" style="width: 11.186%;"><a class="dataTable-sorter" href="#">OPCION</a></th><th data-sortable="" style="width: 4.85175%;"><a class="dataTable-sorter" href="#">N°</a></th><th data-sortable="" hidden="" style="width: 0%;"><a class="dataTable-sorter" href="#">ID</a></th><th data-sortable="" style="width: 14.8922%;"><a class="dataTable-sorter" href="#">IDENTIDAD</a></th><th data-sortable="" style="width: 12.2642%;"><a class="dataTable-sorter" href="#">SECCIÓN</a></th><th data-sortable="" style="width: 8.3558%;"><a class="dataTable-sorter" href="#">FOTO</a></th><th data-sortable="" style="width: 16.6442%;"><a class="dataTable-sorter" href="#">ESTUDIANTE</a></th><th data-sortable="" style="width: 13.4097%;"><a class="dataTable-sorter" href="#">ENTRADA</a></th><th data-sortable="" style="width: 10.7817%;"><a class="dataTable-sorter" href="#">SALIDA</a></th><th data-sortable="" style="width: 7.61456%;"><a class="dataTable-sorter" href="#">TIPO</a></th></tr>
</thead>
<!-- Aquí va tu tabla y demás HTML -->
<tbody><tr><td class="text-center" colspan="9">No hay registros disponibles</td></tr></tbody>
</table></div><div class="dataTable-bottom"><div class="dataTable-info">Showing 1 to 1 of 1 entries</div><ul class="pagination pagination-primary float-end dataTable-pagination"></ul></div></div>
</div>
</div>
</section>
<!-- NEW User Modal -->
...
<h5 class="modal-title" id="modalLongTitle">REPORTE DE ASISTENCIA</h5>
<button aria-label="Close" class="btn-close" data-bs-dismiss="modal" type="button"></button>
</div>
<div class="modal-body">
<form class="row g-3" id="Form_New" onsubmit="return false">
<div class="col-6">
<label for="Combo_Anio">Año:</label>
<select class="form-select form-select-sm" id="Combo_Anio" name="Combo_Anio" required="">
...
<div class="col-6">
<label for="Combo_Mes">Mes:</label>
<select class="form-select form-select-sm" id="Combo_Mes" name="Combo_Mes" required="">
...
<label for="first-name-icon">Grado
                                :</label>
<select class="form-select form-select-sm" id="Combo_Grado" name="Combo_Grado" required="">
...
<label for="first-name-icon">Seccion
                                :</label>
<select class="form-select form-select-sm" id="Combo_Seccion" name="Combo_Seccion" required="">
<option value="">Seleccionar...</option>
<option value="2">B</option><option value="3">C</option><option value="4">A</option><option value="19">A</option>
</select>
</div>
<div class="col-12 text-center">
<button class="btn rounded-pill btn-primary" onclick="Reporte_PDF()" type="submit">
<i class="bx bxs-save"></i>Visualizar</button>
<button aria-label="Close" class="btn rounded-pill btn-danger" data-bs-dismiss="modal" type="reset"> <i class="bx bxs-left-arrow-circle"></i>
                                Cerrar
                            </button>
</div>
</form>
...
//     $('#table1').DataTable({
//         dom: 'Bfrtip', // Agrega los botones en la parte superior
//         buttons: [
//             'copy', 'csv', 'excel', 'pdf', 'print' // Agrega los botones que desees
//         ]
//     });
// });
...
function Reporte_PDF() {
    var Id_Seccion = document.getElementById('Combo_Seccion').value;
    var Seccion = document.getElementById('Combo_Seccion').selectedOptions[0].text;

    var Id_Grado = document.getElementById('Combo_Grado').value;
    var Grado = document.getElementById('Combo_Grado').selectedOptions[0].text;

    var Anio = document.getElementById('Combo_Anio').value;
    var Mes = document.getElementById('Combo_Mes').value;

    $.ajax({
        type: "POST",
        url: "alumnos_asistencia_reporte_resumen.php",
        data: {
        ...
        success: function(response) {
            var pdfUrl = "pdf/reporte_asistencia.pdf";
...
$(document).ready(function() {
    ...
    $('.justifica-falta').on('click', function() {
        const recordId = $(this).data('id'); // Obtener el id del registro

        // Mostrar la confirmación con SweetAlert2
        Swal.fire({
            title: '¿Estás seguro?',
            text: "¡Desea Justificar la Falta!",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: 'alumnos_asistencia_justifica_falta.php',
                    type: 'POST',
                    data: {
                        id: recordId
                    },
                    ...
                    error: function() {
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: 'Hubo un problema al Realizar justificacion.',
                            confirmButtonText: 'Aceptar'
                        });
                    }
                });
...
$(document).ready(function() {
    // Cuando se hace clic en el botón de eliminar
    $('.justifica-tardanza').on('click', function() {
        const recordId = $(this).data('id'); // Obtener el id del registro

        // Mostrar la confirmación con SweetAlert2
        Swal.fire({
            title: '¿Estás seguro?',
            text: "¡Desea Justificar la Tardanza!",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonText: 'Sí, Justificar',
            cancelButtonText: 'Cancelar'
            ...
            if (result.isConfirmed) {
                // Enviar solicitud AJAX para eliminar el registro
                $.ajax({
                    url: 'alumnos_asistencia_justifica_tardanza.php',
                    type: 'POST',
                    data: {
                        id: recordId
                    },
    ...
    $('.delete-record').on('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Enviar solicitud AJAX para eliminar el registro
                $.ajax({
                    url: 'eliminar_registro_asistencia.php',
                    type: 'POST',
                    data: {
                        id: recordId
                    },
