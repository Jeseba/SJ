...
<h6>REPORTE DE ASISTENCIA POR ESTUDIANTE</h6>
<hr/>
</div>
<div class="container my-2">
<form action="alumnos_asistencia_general_pdf_x_alumno.php" method="post">
...
<label for="first-name-icon">Estudiante
                                                        :</label>
<div class="position-relative"><select aria-hidden="true" class="select2 form-select select2-hidden-accessible" data-allow-clear="false" data-select2-id="Combo_Estudiante_New" id="Combo_Estudiante_New" name="Combo_Estudiante_New" tabindex="-1">
<option data-select2-id="8" value="">Seleccionar...</option>
<option value="0"> </option><option value="1">42948117 JOSE WILLIANS NAVARRO YOVERA</option><option value="2">73062410 Margarita Garcia Garcia</option><option value="3">42948110 JOSE WILLIANS NAVARRO YOVERA</option> </select><span class="select2 select2-container select2-container--default" data-select2-id="7" dir="ltr" style="width: 328px;"><span class="selection"><span aria-disabled="false" aria-expanded="false" aria-haspopup="true" aria-labelledby="select2-Combo_Estudiante_New-container" class="select2-selection select2-selection--single" role="combobox" tabindex="0"><span aria-readonly="true" class="select2-selection__rendered" id="select2-Combo_Estudiante_New-container" role="textbox"><span class="select2-selection__placeholder">Select value</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span aria-hidden="true" class="dropdown-wrapper"></span></span></div>
</div>
<div class="col">
<input hidden="" id="texto_combo" name="texto_combo" type="text"/>
</div>
<div class="form-group has-icon-left">
<label for="first-name-icon">Desde :</label>
<div class="position-relative">
<input autofocus="" class="form-control" id="DT_Fecha_Desde" name="DT_Fecha_Desde" placeholder="Ingrese Nombres y Apellidos" required="" type="date"/>
...
<div class="form-group has-icon-left">
<label for="first-name-icon">Hasta :</label>
<div class="position-relative">
<input autofocus="" class="form-control" id="DT_Fecha_Hasta" name="DT_Fecha_Hasta" placeholder="Ingrese Nombres y Apellidos" required="" type="date"/>
<div class="form-control-icon">
<i class="bi bi-calendar-date"></i>
</div>
</div>
...
<div class="form-group has-icon-left">
<label for="first-name-icon">Año
                                                        :</label>
<select class="form-select" id="Combo_Ciclo" name="Combo_Ciclo" required="">
<option value="">Seleccionar...</option>
<option value="1">2025</option>
</select>
</div>
<div class="col">
<input hidden="" id="texto_ciclo" name="texto_ciclo" type="text"/>
</div>
</div>
</div>
<div class="row">
...
<button class="btn btn-primary btn-sm" name="mostrar" type="submit">Generar
                                                    PDF</button>
</div>
</div>
<div class="row">
...
$(document).ready(function() {
    ...
    $('#Combo_Estudiante_New').on('change', function() {
        let textoSeleccionado = $("#Combo_Estudiante_New option:selected").text();
        $("#texto_combo").val(textoSeleccionado);
    });
});
...
document.addEventListener('DOMContentLoaded', function() {
    var select = document.getElementById('Combo_Ciclo');
    var input = document.getElementById('texto_ciclo');

    select.addEventListener('change', function() {
        // Obtén el índice de la opción seleccionada
        var selectedIndex = select.selectedIndex;

        // Obtén el texto de la opción seleccionada usando el índice
        var selectedText = select.options[selectedIndex].text;

        // Asigna el texto al input
...
function toggleSwitch() {
    // swuict del madre
    var switchInput = document.getElementById('che_desglose');
    var hiddenInput = document.getElementsByName('Valor_Desglose')[0];
    document.getElementById('Valor_Desglose').value = switchInput.checked ? '1' : '0';
}

// Maneja el cambio de estado del switch
document.getElementById('che_desglose').addEventListener('change', handleSwitchState);
</script>
<!-- <footer>
