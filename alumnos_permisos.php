...
<h3>Permisos de Estudiantes</h3>
<p class="text-subtitle text-muted">Registro de Permisos y Justificaciones</p>
</div>
</div>
<!-- <a class="btn btn-primary" href="alumnos_padres_lista.php">Atras
...
<a class="btn btn-primary" href="alumnos_permisos_form_new.php">Nuevo
                                            <i aria-hidden="true" class="bi bi-plus"></i>
</a>
</div>
</div>
</div>
<!-- <button type="button" id="mostrar_pdf" class="btn btn-warning">PDF
                                        <i class="bi-file-earmark-post-fill" aria-hidden="true"></i></button> -->
</div></form>
</div>
<div class="card-body">
...
<thead>
<tr><th data-sortable="" style="width: 5.22284%;"><a class="dataTable-sorter" href="#">N°</a></th><th data-sortable="" hidden="" style="width: 0%;"><a class="dataTable-sorter" href="#">ID</a></th><th data-sortable="" style="width: 8.98329%;"><a class="dataTable-sorter" href="#">FOTO</a></th><th data-sortable="" style="width: 10.7242%;"><a class="dataTable-sorter" href="#">FECHA</a></th><th data-sortable="" style="width: 16.156%;"><a class="dataTable-sorter" href="#">IDENTIDAD</a></th><th data-sortable="" style="width: 13.3008%;"><a class="dataTable-sorter" href="#">SECCIÓN</a></th><th data-sortable="" style="width: 18.0362%;"><a class="dataTable-sorter" href="#">ESTUDIANTE</a></th><th data-sortable="" style="width: 12.3259%;"><a class="dataTable-sorter" href="#">MOTIVO</a></th><th data-sortable="" style="width: 15.2507%;"><a class="dataTable-sorter" href="#">OPCIONES</a></th></tr>
</thead>
<tbody><tr><td class="dataTables-empty" colspan="9">No entries found</td></tr></tbody>
