...
<h3>AUXILIARES</h3>
<p class="text-subtitle text-muted">Agrega o modificar Auxiliares</p>
</div>
</div>
...
<div>
<a class="btn btn-primary" href="auxiliares_form_nuevo.php">Nuevo
                            <i class="bi-plus"></i>
</a>
...
<div class="card-body">
<div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns"><div class="dataTable-top"><div class="dataTable-dropdown"><select class="dataTable-selector form-select"><option selected="" value="100">100</option><option value="200">200</option><option value="500">500</option></select><label>Mostrar por pagina</label></div><div class="dataTable-search"><input class="dataTable-input" placeholder="Search..." type="text"/></div></div><div class="dataTable-container"><table class="table table-striped dataTable-table" id="table1">
<thead>
<tr><th data-sortable="" style="width: 11.8598%;"><a class="dataTable-sorter" href="#">COD.</a></th><th data-sortable="" style="width: 20.1482%;"><a class="dataTable-sorter" href="#">DNI</a></th><th data-sortable="" style="width: 42.7898%;"><a class="dataTable-sorter" href="#">AUXILIAR</a></th><th data-sortable="" style="width: 25.2022%;"><a class="dataTable-sorter" href="#">Acciones</a></th></tr>
</thead>
<tbody><tr><td>4</td><td>41526378</td><td>BALTAZAR | 927020652</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="auxiliares_form_edit.php?id=4"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(4)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>1</td><td>42948117</td><td>GRIMILDA | 968481723</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="auxiliares_form_edit.php?id=1"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(1)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>2</td><td>52634188</td><td>MILAGROS | 967143400</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="auxiliares_form_edit.php?id=2"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(2)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr></tbody>
</table></div><div class="dataTable-bottom"><div class="dataTable-info">Showing 1 to 3 of 3 entries</div><ul class="pagination pagination-primary float-end dataTable-pagination"></ul></div></div>
</div>
</div>
</section>
...
let dataTable = new simpleDatatables.DataTable(table1, {
    perPage: 100, // Muestra 100 filas por página
    perPageSelect: [100, 200, 500] // Opciones para cambiar la cantidad de filas
});
    ...
    function eliminarEstudianteEnServidor(idEstudiante) {
        ...
        $.ajax({
            type: 'POST',
            url: 'auxiliares_del.php', // Ajusta la URL según tu configuración
            data: {
...
<script src="auxiliares_edit.js"></script>
<!-- <footer>
