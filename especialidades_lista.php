...
<p class="text-subtitle text-muted">Agrega o modificar Especialidades</p>
<div class="col-12 col-md-6">
<img alt="" id="Imagen_Float" src="assets/images/img_school/especialidades.png"/>
</div>
</div>
</div>
...
<div>
<a class="btn btn-primary" href="especialidades_form_nuevo.php">Nuevo
                            <i class="bi-plus"></i>
</a>
...
<thead>
<tr><th data-sortable="" style="width: 16.4057%;"><a class="dataTable-sorter" href="#">COD.</a></th><th data-sortable="" style="width: 48.8087%;"><a class="dataTable-sorter" href="#">ESPECIALIDAD</a></th><th data-sortable="" style="width: 34.7856%;"><a class="dataTable-sorter" href="#">Acciones</a></th></tr>
</thead>
<tbody><tr><td>12</td><td>ADMINISTRATIVO</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="especialidades_form_edit.php?id=12"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(12)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>4</td><td>ARTE Y CULTURA</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="especialidades_form_edit.php?id=4"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(4)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>6</td><td>CIENCIA SOCIALES</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="especialidades_form_edit.php?id=6"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(6)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>2</td><td>COMUNICACION</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="especialidades_form_edit.php?id=2"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(2)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>5</td><td>CyT</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="especialidades_form_edit.php?id=5"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(5)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>7</td><td>D.P.C.C</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="especialidades_form_edit.php?id=7"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(7)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>9</td><td>E.P.T</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="especialidades_form_edit.php?id=9"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(9)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>8</td><td>EDUCACION FISICA</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="especialidades_form_edit.php?id=8"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(8)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>11</td><td>INGLES</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="especialidades_form_edit.php?id=11"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(11)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>1</td><td>MATEMATICA</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="especialidades_form_edit.php?id=1"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(1)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr></tbody>
</table></div><div class="dataTable-bottom"><div class="dataTable-info">Showing 1 to 10 of 11 entries</div><ul class="pagination pagination-primary float-end dataTable-pagination"><li class="page-item pager"><a class="page-link" data-page="1" href="#">‹</a></li><li class="page-item active"><a class="page-link" data-page="1" href="#">1</a></li><li class="page-item"><a class="page-link" data-page="2" href="#">2</a></li><li class="page-item pager"><a class="page-link" data-page="2" href="#">›</a></li></ul></div></div>
</div>
</div>
</section>
...
<script>
    ...
    function eliminarEstudianteEnServidor(idEstudiante) {
        ...
        $.ajax({
            type: 'POST',
            url: 'especialidades_del.php', // Ajusta la URL según tu configuración
            data: {
