...
<h3>CICLOS</h3>
<p class="text-subtitle text-muted">Registro de Ciclos</p>
<div class="col-12 col-md-6">
<img alt="" id="Imagen_Float" src="assets/images/img_school/cierre_academico.png"/>
</div>
</div>
</div>
...
<div>
<a class="btn btn-primary" href="ciclos_form_nuevo.php">Nuevo
                            <i class="bi-plus"></i>
</a>
</div>
</div>
...
<thead>
<tr><th data-sortable="" style="width: 12.5337%;"><a class="dataTable-sorter" href="#">COD.</a></th><th data-sortable="" style="width: 14.4879%;"><a class="dataTable-sorter" href="#">CICLO</a></th><th data-sortable="" style="width: 24.3261%;"><a class="dataTable-sorter" href="#">INICIA</a></th><th data-sortable="" style="width: 24.3935%;"><a class="dataTable-sorter" href="#">TERMINA</a></th><th data-sortable="" style="width: 24.2588%;"><a class="dataTable-sorter" href="#">Acciones</a></th></tr>
</thead>
<tbody><tr><td>1</td><td>2025</td><td>2025-03-03</td><td>2025-12-31</td><td>
<div class="d-flex">
<!-- <a href="turnos_form_edit.php?id=1"
                                        class="btn btn-primary shadow btn-xs sharp m-1"><i class="bi bi-pencil"></i></a> -->
<a class="editar-modal-btn" data-registro-id="1" href=" #">
...
<h5 class="modal-title" id="modalLongTitle">EDITAR REGISTRO</h5>
...
<label class="form-label" for="modalEditUserEmail">Ciclo</label>
<input class="form-control form-control-sm" id="T_Ciclo_Edit" placeholder="Ciclo" type="text"/>
</div>
<div class="col-12 col-md-6">
<label class="form-label" for="modalEditUserEmail">Inicia</label>
<input class="form-control form-control-sm" id="T_Inicia_Edit" type="date"/>
</div>
<div class="col-12 col-md-6">
<label class="form-label" for="modalEditUserEmail">Termina</label>
<input class="form-control form-control-sm" id="T_Termina_Edit" type="date"/>
</div>
<div class="col-12 text-center">
<button class="btn rounded-pill btn-primary btn-sm" onclick="Editar_Ciclo_Model()" type="submit">
...
<script src="ciclosController.js"></script>
<script>
    // Simple Datatable
    ...
    function eliminarEstudianteEnServidor(idEstudiante) {
        ...
        $.ajax({
            type: 'POST',
            url: 'turnos_del.php', // Ajusta la URL según tu configuración
            data: {
...
<script>
    $(document).ready(function() {
        $('#table1').on('click', '.editar-modal-btn', async function(event) {
            ...
            $.ajax({
                ...
                if (datosRegistro && datosRegistro.id) {
                    ...
                    $('#T_Ciclo_Edit').val(datosRegistro.ciclo);
                    $('#T_Inicia_Edit').val(datosRegistro.inicio);
                    $('#T_Termina_Edit').val(datosRegistro.termina);
                    $('#Activo').prop('checked', 1);
                    // $('#Activo').prop('checked', datosRegistro.activo == 1);
