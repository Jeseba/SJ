...
<div class="col-md-8">
<h6 class="text-muted font-semibold">Asistencias</h6>
<h6 class="font-extrabold mb-0" id="contador_asistencias">0                                    </h6>
</div>
</div>
</div>
</div>
...
<div class="col-md-8">
<h6 class="text-muted font-semibold">Maestros</h6>
...
<div class="col-md-8">
<h6 class="text-muted font-semibold">Permisos</h6>
<h6 class="font-extrabold mb-0">3</h6>
</div>
</div>
</div>
...
<h4> 🎂 CUMPLEAÑOS DE HOY<i class="fa" style="color:#FFFFFF; width:12; height:12;">
                                    🎈</i></h4>
</div>
<div class="card-body">
<div class="dataTable-wrapper dataTable-loading dataTable-empty no-footer sortable searchable fixed-columns"><div class="dataTable-top"><div class="dataTable-dropdown"><select class="dataTable-selector form-select"><option value="5">5</option><option selected="" value="10">10</option><option value="15">15</option><option value="20">20</option><option value="25">25</option></select><label>Mostrar por pagina</label></div><div class="dataTable-search"><input class="dataTable-input" placeholder="Search..." type="text"/></div></div><div class="dataTable-container"><table class="table table-striped table-responsive border rounded dataTable-table" id="table1">
<thead>
<tr><th data-sortable="" hidden="" style="width: 0%;"><a class="dataTable-sorter" href="#">ID</a></th><th data-sortable="" style="width: 5.99769%;"><a class="dataTable-sorter" href="#">N°</a></th><th data-sortable="" style="width: 10.2422%;"><a class="dataTable-sorter" href="#">FOTO</a></th><th data-sortable="" style="width: 18.4544%;"><a class="dataTable-sorter" href="#">IDENTIDAD</a></th><th data-sortable="" style="width: 15.1326%;"><a class="dataTable-sorter" href="#">SECCION</a></th><th data-sortable="" style="width: 15.3172%;"><a class="dataTable-sorter" href="#">ALUMNO</a></th><th data-sortable="" style="width: 20.5767%;"><a class="dataTable-sorter" href="#">NACIMIENTO</a></th><th data-sortable="" style="width: 14.3022%;"><a class="dataTable-sorter" href="#">ESTADO</a></th></tr>
</thead>
<tbody><tr><td class="dataTables-empty" colspan="8">No entries found</td></tr></tbody>
...
<div class="card">
<div class="card-header">
<h4> 📢 "TE AVISAMOS" , ESTAN DE CUMPLEAÑOS ESTE MES<i class="fa" style="color:#FFFFFF; width:12; height:12;"> __ 🔻 </i></h4>
</div>
<div class="card-body">
<div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns"><div class="dataTable-top"><div class="dataTable-dropdown"><select class="dataTable-selector form-select"><option value="5">5</option><option selected="" value="10">10</option><option value="15">15</option><option value="20">20</option><option value="25">25</option></select><label>Mostrar por pagina</label></div><div class="dataTable-search"><input class="dataTable-input" placeholder="Search..." type="text"/></div></div><div class="dataTable-container"><table class="table table-striped table-responsive border rounded dataTable-table" id="table2">
<thead>
<tr><th data-sortable="" hidden="" style="width: 0%;"><a class="dataTable-sorter" href="#">ID</a></th><th data-sortable="" style="width: 4.24452%;"><a class="dataTable-sorter" href="#">N°</a></th><th data-sortable="" style="width: 8.21223%;"><a class="dataTable-sorter" href="#">FOTO</a></th><th data-sortable="" style="width: 13.0104%;"><a class="dataTable-sorter" href="#">IDENTIDAD</a></th><th data-sortable="" style="width: 10.7036%;"><a class="dataTable-sorter" href="#">SECCION</a></th><th data-sortable="" style="width: 35.0634%;"><a class="dataTable-sorter" href="#">ALUMNO</a></th><th data-sortable="" style="width: 15.8708%;"><a class="dataTable-sorter" href="#">NACIMIENTO</a></th><th data-sortable="" style="width: 10.8881%;"><a class="dataTable-sorter" href="#">ESTADO</a></th></tr>
</thead>
<tbody><tr><td hidden="">2</td><td>1</td><td><img class="rounded-circle border border-4" src="assets/images/img_alumnos/sinfoto.png" width="50"/></td><td>73062410</td><td></td><td>Margarita Garcia Garcia</td><td>📇12-06-2025</td><td>
<span class="btn btn-light">Activo</span>
</td><td>
</td></tr><tr><td hidden="">3</td><td>2</td><td><img class="rounded-circle border border-4" src="assets/images/img_alumnos/sinfoto.png" width="50"/></td><td>42948110</td><td></td><td>JOSE WILLIANS NAVARRO YOVERA</td><td>📇04-06-2025</td><td>
<span class="btn btn-light">Activo</span>
</td><td>
</td></tr></tbody>
</table></div><div class="dataTable-bottom"><div class="dataTable-info">Showing 1 to 2 of 2 entries</div><ul class="pagination pagination-primary float-end dataTable-pagination"></ul></div></div>
</div>
</div>
</div>
</div>
...
<div class="card">
<div class="card-header">
<h4 class="text-center">ESTUDIANTES DEL INSTITUTO</h4>
<!-- <button class='btn btn-block btn-xl btn-light-primary font-bold mt-3'>Todo</button> -->
<a class="btn btn-block btn-xl btn-light-primary font-bold mt-3" href="alumnos_lista.php">Ver
                        Todos
                    </a>
</div>
...
<img src="assets/images/img_alumnos/sinfoto.png"/>
</div>
<div class="name ms-4">
<h5 class="mb-1">JOSE WILLIANS</h5>
<h6 class="text-muted mb-0">NAVARRO YOVERA</h6>
</div>
</div>
<div class="recent-message d-flex px-4 py-3">
<div class="avatar avatar-lg">
...
<div class="name ms-4">
<h5 class="mb-1">Margarita</h5>
<h6 class="text-muted mb-0">Garcia Garcia</h6>
</div>
</div>
<div class="recent-message d-flex px-4 py-3">
<div class="avatar avatar-lg">
...
function actualizarContadorAsistencias() {
    $.ajax({
        url: 'home_contar_asistencias.php',
        method: 'GET',
        success: function(data) {
            // console.log('Valor del contador : ' + data.total_asistencias);
            if (data.total_asistencias !== undefined) {
                $('#contador_asistencias').text(data.total_asistencias);
            } else {
...
// Llama a esta función cuando se registre una nueva asistencia
// O para actualizar periódicamente
setInterval(actualizarContadorAsistencias, 5000); // Actualiza cada 5 segundos
</script>
<!-- <footer>
