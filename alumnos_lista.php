...
<h3>Estudiantes del Instituto</h3>
<p class="text-subtitle text-muted">Selecciona "Nuevo" para Registrar un nuevo Estudiante</p>
</div>
</div>
</div>
...
<a class="btn btn-primary" href="alumnos_form_nuevo.php">Nuevo
                                <i class="bi-plus"></i>
</a>
</div>
<div class="col-sm-12 col-md-12 col-lg-3 col-xl-3">
<button class="btn btn-secondary" id="btnRecargar">Todo</button>
</div>
<div class="col-sm-12 col-md-12 col-lg-3 col-xl-3">
<div class="form-group has-icon-left">
<label for="first-name-icon">Grado
                                    :</label>
<select class="form-select" id="Combo_Grado" name="Combo_Grado" required="">
<option value="">Seleccionar...</option>
<option value="1">1ero</option><option value="2">2DO</option><option value="3">3ERO</option><option value="4">4TO</option><option value="6">5TO</option>
</select>
</div>
</div>
<div class="col-sm-12 col-md-12 col-lg-3 col-xl-3">
<div class="form-group has-icon-left">
<label for="first-name-icon">Seccion
                                    :</label>
<select class="form-select" id="Combo_Seccion" name="Combo_Seccion" required="">
<option value="">Seleccionar...</option>
<option value="2">B</option><option value="3">C</option><option value="4">A</option><option value="19">A</option>
</select>
</div>
</div>
<div class="col-12 col-md-12 d-flex align-items-center justify-content-end gap-3">
<!-- Botón para abrir el modal -->
<button class="btn btn-info btn-sm me-2" data-bs-target="#modalSeccion" data-bs-toggle="modal">
<i class="bi bi-card-list"></i> Impresión de Carnets
                            </button>
<!-- Botón para importar Excel -->
<button class="btn btn-success btn-sm me-2" data-bs-target="#importModal" data-bs-toggle="modal">
<i class="bi bi-file-earmark-arrow-up"></i> Importar Excel
                            </button>
<!-- Enlace como botón -->
<a class="btn btn-outline-secondary btn-sm" download="" href="/formato_excel/students_xls.xlsx">
...
<div class="card-body">
<div class="dataTable-wrapper dataTable-loading dataTable-empty no-footer sortable searchable fixed-columns"><div class="dataTable-top"><div class="dataTable-dropdown"><select class="dataTable-selector form-select"><option value="5">5</option><option selected="" value="10">10</option><option value="15">15</option><option value="20">20</option><option value="25">25</option></select><label>Mostrar por pagina</label></div><div class="dataTable-search"><input class="dataTable-input" placeholder="Search..." type="text"/></div></div><div class="dataTable-container"><table class="table table-striped border rounded dataTable-table" id="table1">
<thead>
<tr><th data-sortable="" hidden="" style="width: 0%;"><a class="dataTable-sorter" href="#">ID</a></th><th data-sortable="" style="width: 4.73538%;"><a class="dataTable-sorter" href="#">N°</a></th><th data-sortable="" style="width: 8.14763%;"><a class="dataTable-sorter" href="#">FOTO</a></th><th data-sortable="" style="width: 14.624%;"><a class="dataTable-sorter" href="#">IDENTIDAD</a></th><th data-sortable="" style="width: 15.1114%;"><a class="dataTable-sorter" href="#">CODIGO QR</a></th><th data-sortable="" style="width: 10.5153%;"><a class="dataTable-sorter" href="#">GRADO</a></th><th data-sortable="" style="width: 12.0474%;"><a class="dataTable-sorter" href="#">SECCION</a></th><th data-sortable="" style="width: 12.117%;"><a class="dataTable-sorter" href="#">ALUMNO</a></th><th data-sortable="" style="width: 11.2117%;"><a class="dataTable-sorter" href="#">ESTADO</a></th><th data-sortable="" style="width: 11.4903%;"><a class="dataTable-sorter" href="#">Acciones</a></th></tr>
</thead>
<tbody><tr><td class="dataTables-empty" colspan="10">No entries found</td></tr></tbody>
</table></div><div class="dataTable-bottom"><div class="dataTable-info"></div><ul class="pagination pagination-primary float-end dataTable-pagination"></ul></div></div>
</div>
</div>
</div></section>
...
<form action="alumnos_lista_importar_excel.php" enctype="multipart/form-data" id="importForm" method="POST">
<div class="row">
<div class="col-12 col-sm-6">
<div class="form-group has-icon-left">
<label for="first-name-icon">Grado
                                    :</label>
<select class="form-select" id="Combo_Grados_i" name="Combo_Grados_i" required="">
<!-- <option value="">Seleccionar...</option> -->
<option value="1">1ero</option><option value="2">2DO</option><option value="3">3ERO</option><option value="4">4TO</option><option value="6">5TO</option>
</select>
</div>
...
<label for="first-name-icon">Seccion
                                    :</label>
<select class="form-select" id="Combo_Secciones_i" name="Combo_Secciones_i" required="">
<!-- <option value="">Seleccionar...</option> -->
<option value="2">B</option><option value="3">C</option><option value="4">A</option><option value="19">A</option>
</select>
</div>
...
<div class="col-12">
<div class="form-group has-icon-left">
<label for="first-name-icon">Auxiliar
                                    :</label>
<select class="form-select" id="Combo_Auxiliares_i" name="Combo_Auxiliares_i" required="">
<!-- <option value="">Seleccionar...</option> -->
<option value="1">GRIMILDA | 968481723</option><option value="2">MILAGROS | 967143400</option><option value="4">BALTAZAR | 927020652</option>
</select>
</div>
</div>
</div>
<div class="mb-3">
<label class="form-label" for="excel_file">Selecciona un archivo Excel</label>
<input accept=".xlsx, .xls" class="form-control" id="excel_file" name="excel_file" required="" type="file"/>
</div>
<div class="progress d-none" id="progress-container">
<div class="progress-bar progress-bar-striped progress-bar-animated" id="progress-bar" role="progressbar">0%</div>
</div>
<div class="mt-3 text-end">
<button class="btn btn-success d-none" id="upload_button" type="submit">
                            Procesar <i class="bi bi-upload"></i>
</button>
</div>
</form>
</div>
...
<!-- Modal para ingresar la sección -->
<div aria-hidden="true" aria-labelledby="modalSeccionLabel" class="modal fade" id="modalSeccion" tabindex="-1">
<div class="modal-dialog">
<div class="modal-content">
<div class="modal-header">
<h5 class="modal-title" id="modalSeccionLabel">Ingresar Sección</h5>
<button aria-label="Close" class="btn-close" data-bs-dismiss="modal" type="button"></button>
</div>
<div class="modal-body">
<form id="formSeccion">
...
<label for="first-name-icon">Grado
                                        :</label>
<select class="form-select" id="Combo_Grados" name="Combo_Grados" required="">
<option value="">Seleccionar...</option>
<option value="1">1ero</option><option value="2">2DO</option><option value="3">3ERO</option><option value="4">4TO</option><option value="6">5TO</option>
</select>
</div>
...
<label for="first-name-icon">Seccion
                                        :</label>
<select class="form-select" id="Combo_Secciones" name="Combo_Secciones" required="">
<option value="">Seleccionar...</option>
<option value="2">B</option><option value="3">C</option><option value="4">A</option><option value="19">A</option>
</select>
</div>
...
<button class="btn btn-primary" type="submit">Generar Carnets</button>
</form>
</div>
</div>
</div>
...
$(document).ready(function() {
    ...
    $("#Combo_Grado, #Combo_Seccion").on("change", function() {
        cargarTabla();
    });

    function cargarTabla() {
        let grado = $("#Combo_Grado").val();
        let seccion = $("#Combo_Seccion").val();

        $.ajax({
            url: "alumnos_cargar_estudiantes.php",
            type: "POST",
            data: {
                grado: grado,
                seccion: seccion
...
<script>
document.getElementById('formSeccion').addEventListener('submit', function(e) {
    e.preventDefault();

    let seccion = document.getElementById('Combo_Secciones').value.trim();
    let grado = document.getElementById('Combo_Grados').value.trim(); // Capturar el valor del Combo_Grado

    if (seccion && grado) {
        // Pasar ambos parámetros a la URL
        window.open(`generar_carnets_por_seccion.php?seccion=${seccion}&grado=${grado}`, '_blank');
    } else {
        alert('Por favor ingrese una sección y un grado.');
    }
});
</script>
<script>
document.getElementById('excel_file').addEventListener('change', function() {
    ...
    uploadButton.classList.toggle('d-none', !this.files.length);
});
...
document.getElementById('importForm').addEventListener('submit', async function(e) {
    ...
    progressContainer.classList.add('d-none'); // Ocultar la barra de progreso después del proceso
    this.reset();
    document.getElementById('upload_button').classList.add('d-none');
});
</script>
<script>
function mostrar_carnet(id) {
    ...
    xhr.open('GET', 'carnet.php?id=' + id, true);
...
function confirmarEliminar(idEstudiante) {
    Swal.fire({
        title: '¿Inactivar Estudiante por falta de Ausencia?',
...
function eliminarEstudianteEnServidor(idEstudiante) {
    ...
    $.ajax({
        type: 'POST',
        url: 'alumnos_del.php', // Ajusta la URL según tu configuración
        data: {
...
function confirmarRetornar(idEstudiante) {
    Swal.fire({
        ...
        text: '¡¿Estás seguro de Habilitar Estudiante?',
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
function HabilitarEstudianteEnServidor(idEstudiante) {
    ...
    $.ajax({
        type: 'POST',
        url: 'alumnos_habilitar_baja.php', // Ajusta la URL según tu configuración
        data: {
            idEstudiante: idEstudiante
        },
        dataType: 'json',
