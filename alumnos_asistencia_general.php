...
<h6>REPORTE GENERAL DE ASISTENCIA</h6>
<hr/>
</div>
<div class="container my-2">
<form action="alumnos_asistencia_general_pdf.php" method="post">
...
<!-- <div class="form-group has-icon-left">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="date" class="form-control"
                                                            placeholder="Ingrese Nombres y Apellidos" id="DT_Fecha_Hasta"
                                                            name="DT_Fecha_Hasta" autofocus required>
                                                        <div class="form-control-icon">
                                                            <i class="bi bi-calendar-date"></i>
                                                        </div>
                                                    </div>
...
<input class="form-check-input" id="che_desglose" onclick="toggleSwitch()" role="switch" type="checkbox"/>
<label class="form-check-label" for="che_desglose">Detalles de Sección</label>
<input hidden="" id="Valor_Desglose" name="Valor_Desglose"/>
</div>
</div>
