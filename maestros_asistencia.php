...
<thead>
<tr><th data-sortable="" style="width: 9.7035%;"><a class="dataTable-sorter" href="#">OPCION</a></th><th data-sortable="" style="width: 4.1779%;"><a class="dataTable-sorter" href="#">N°</a></th><th data-sortable="" style="width: 12.938%;"><a class="dataTable-sorter" href="#">IDENTIDAD</a></th><th data-sortable="" style="width: 14.8922%;"><a class="dataTable-sorter" href="#">ESPECIALIDD</a></th><th data-sortable="" style="width: 7.21024%;"><a class="dataTable-sorter" href="#">FOTO</a></th><th data-sortable="" style="width: 23.4501%;"><a class="dataTable-sorter" href="#">NOMBRES APELLIDOS</a></th><th data-sortable="" style="width: 11.6577%;"><a class="dataTable-sorter" href="#">ENTRADA</a></th><th data-sortable="" style="width: 9.36658%;"><a class="dataTable-sorter" href="#">SALIDA</a></th><th data-sortable="" style="width: 6.60377%;"><a class="dataTable-sorter" href="#">TIPO</a></th></tr>
</thead>
...
function Reporte_PDF() {
    ...
    $.ajax({
        type: "POST",
        url: "maestros_asistencia_reporte_resumen.php",
        data: {
        ...
        success: function(response) {
            var pdfUrl = "pdf/reporte_asistencia_maestros.pdf";
    ...
    $('.delete-record').on('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Enviar solicitud AJAX para eliminar el registro
                $.ajax({
                    url: 'eliminar_registro_asistencia_maestros.php',
                    type: 'POST',
                    data: {
                        id: recordId
                    },
