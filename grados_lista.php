...
<h3>GRADOS</h3>
<p class="text-subtitle text-muted">Agrega o modificar Grados</p>
...
<div>
<a class="btn btn-primary" href="grados_form_nuevo.php">Nuevo
                            <i class="bi-plus"></i>
</a>
</div>
</div>
...
<thead>
<tr><th data-sortable="" style="width: 22.2372%;"><a class="dataTable-sorter" href="#">COD.</a></th><th data-sortable="" style="width: 30.593%;"><a class="dataTable-sorter" href="#">GRADO</a></th><th data-sortable="" style="width: 47.1698%;"><a class="dataTable-sorter" href="#">OPCIONES</a></th></tr>
</thead>
<tbody><tr><td>1</td><td>1ero</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="grados_form_edit.php?id=1"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(1)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>2</td><td>2DO</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="grados_form_edit.php?id=2"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(2)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>3</td><td>3ERO</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="grados_form_edit.php?id=3"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(3)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>4</td><td>4TO</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="grados_form_edit.php?id=4"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(4)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>6</td><td>5TO</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="grados_form_edit.php?id=6"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(6)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr></tbody>
</table></div><div class="dataTable-bottom"><div class="dataTable-info">Showing 1 to 5 of 5 entries</div><ul class="pagination pagination-primary float-end dataTable-pagination"></ul></div></div>
</div>
</div>
</section>
...
<script>
    ...
    function eliminarEstudianteEnServidor(idEstudiante) {
        ...
        $.ajax({
            type: 'POST',
            url: 'grados_del.php', // Ajusta la URL según tu configuración
            data: {
...
<script src="grados_edit.js"></script>
<!-- <footer>
