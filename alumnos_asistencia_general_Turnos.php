...
<h6>REPORTE DE ASISTENCIA POR TURNOS</h6>
<hr/>
</div>
<div class="container my-2">
<form action="alumnos_asistencia_general_pdf_Turnos.php" method="post">
...
<label for="first-name-icon">Turno
                                                    :</label>
<select class="form-select" id="Combo_Turno" name="Combo_Turno" required="">
<option value="">Seleccionar...</option>
<option value="1">MAÑANA</option><option value="2">TARDE</option>
</select>
</div>
<div class="col">
...
<div class="form-group has-icon-left">
<label for="first-name-icon">Fecha :</label>
...
<!-- <div class="form-group has-icon-left">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="date" class="form-control"
                                                            ...
                                                            id="DT_Fecha_Hasta" name="DT_Fecha_Hasta" autofocus
                                                            required>
                                                        <div class="form-control-icon">
                                                            <i class="bi bi-calendar-date"></i>
                                                        </div>
...
<!-- <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" role="switch"
                                                        id="che_desglose" onclick="toggleSwitch()">
                                                    <label class="form-check-label" for="che_desglose">Detalle de
                                                        Sección</label>
                                                    <input name="Valor_Desglose" id="Valor_Desglose" hidden>
                                                </div> -->
</div>
</div>
<div class="row">
...
<script>
    ...
    var select = document.getElementById('Combo_Turno');
    var input = document.getElementById('texto_combo');
