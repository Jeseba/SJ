...
$(document).ready(function() {
    $('#formEnviarMensaje').on('submit', function(e) {
        ...
        $.ajax({
            url: 'wasap_obtener_asistencias.php',
            type: 'POST',
            data: {
                fecha: fecha
            },
            success: function(response) {
                ...
                function enviarMensaje(i) {
                    if (i < estudiantes.length) {
                        ...
                        var entradaHora = new Date(estudiantes[i].entrada).toLocaleTimeString('es-PE', {
                            hour: '2-digit',
                            minute: '2-digit'
                        });

                        var mensaje = `Sr. padre/madre, su hijo(a) ${estudiantes[i].names} ${estudiantes[i].surnames} acaba de ingresar a las ${entradaHora}.`;
