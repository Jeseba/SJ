...
<h3>SECCIONES</h3>
<p class="text-subtitle text-muted">Agrega o modificar Secciones</p>
<div class="col-12 col-md-6">
<img alt="" id="Imagen_Float" src="assets/images/img_school/SECCIONES.png"/>
</div>
</div>
</div>
...
<div>
<a class="btn btn-primary" href="secciones_form_nuevo.php">Nuevo
                            <i class="bi-plus"></i>
</a>
</div>
</div>
...
<thead>
<tr><th data-sortable="" style="width: 12.938%;"><a class="dataTable-sorter" href="#">COD.</a></th><th data-sortable="" style="width: 20.4178%;"><a class="dataTable-sorter" href="#">SECCION</a></th><th data-sortable="" style="width: 39.1509%;"><a class="dataTable-sorter" href="#">AUXILIAR</a></th><th data-sortable="" style="width: 27.4933%;"><a class="dataTable-sorter" href="#">OPCIONES</a></th></tr>
</thead>
<tbody><tr><td>4</td><td>A</td><td>Cesar Omar Carrillo </td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="secciones_form_edit.php?id=4"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(4)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>19</td><td>A</td><td>Armando Hernández </td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="secciones_form_edit.php?id=19"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(19)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>2</td><td>B</td><td>Laura Macias </td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="secciones_form_edit.php?id=2"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(2)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr><tr><td>3</td><td>C</td><td>LISET AQUINO</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="secciones_form_edit.php?id=3"><i class="bi bi-pencil"></i></a>
<button class="btn btn-danger shadow btn-xs sharp m-1" onclick="confirmarEliminar(3)">
<i class="bi bi-trash"></i></button>
</div>
</td></tr></tbody>
</table></div><div class="dataTable-bottom"><div class="dataTable-info">Showing 1 to 4 of 4 entries</div><ul class="pagination pagination-primary float-end dataTable-pagination"></ul></div></div>
</div>
</div>
</section>
...
<script>
    ...
    function eliminarEstudianteEnServidor(idEstudiante) {
        ...
        $.ajax({
            type: 'POST',
            url: 'secciones_del.php', // Ajusta la URL según tu configuración
            data: {
...
<script src="secciones_edit.js"></script>
<!-- <footer>
