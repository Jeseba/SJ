...
<h3>Telefonos</h3>
<p class="text-subtitle text-muted">Agrega o modificar Telefonos de Marcacion</p>
</div>
</div>
...
<div>
<a class="btn btn-primary" href="moviles_form_nuevo.php">Nuevo
                            <i class="bi-plus"></i>
</a>
</div>
</div>
...
<thead>
<tr><th data-sortable="" style="width: 2.65458%;"><a class="dataTable-sorter" href="#">COD.</a></th><th data-sortable="" style="width: 4.92304%;"><a class="dataTable-sorter" href="#">NUMERO</a></th><th data-sortable="" style="width: 8.88078%;"><a class="dataTable-sorter" href="#">INSTANCIA</a></th><th data-sortable="" style="width: 77.9481%;"><a class="dataTable-sorter" href="#">TOKENS</a></th></tr>
</thead>
<tbody><tr><td>1</td><td>994853575</td><td>NTE5OTQ4NTM1NzU=</td><td>eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIzODA5OSIsImh0dHA6Ly9zY2hlbWFzLm1pY3Jvc29mdC5jb20vd3MvMjAwOC8wNi9pZGVudGl0eS9jbGFpbXMvcm9sZSI6ImNvbnN1bHRvciJ9.V2TmrkGzxp1Ln42yPpQo_-gW1vnwP4o5Cczg4lKcDus</td><td>
<div class="d-flex">
<a class="btn btn-primary shadow btn-xs sharp m-1" href="moviles_form_edit.php?id=1"><i class="bi bi-pencil"></i></a>
...
<script>
    ...
    function eliminarEstudianteEnServidor(idEstudiante) {
        ...
        $.ajax({
            type: 'POST',
            url: 'moviles_del.php', // Ajusta la URL según tu configuración
            data: {
...
<script src="moviles_edit.js"></script>
<!-- <footer>
